...
<template>
  <main id="appointments-page" class="content-lanes">
    <section id="content">
      <div class="child">
        ...
        <h3 v-if="appointmentStore.appointment">
          Appointment Created. Id: {{ appointmentStore.appointment.id }}
        </h3>
        <button
          type="button"
          @click="
      ...
      <div class="child">
        ...
        <button
          ...
          "
          :disabled="appointmentStore.isUpdating"
        >
      ...
      <div class="child">
        ...
        <button
          type="button"
          @click="appointmentStore.fetchAppointmentById(getAppointment)"
          :disabled="appointmentStore.isFetching"
        >
          {{ appointmentStore.isFetching ? 'Getting Appointment...' : 'Get Appointment by Id' }}
        </button>
        <h3 v-if="appointmentStore.appointment && appointmentStore.gotten">
          Appointment Information: {{ appointmentStore.appointment }}
        </h3>
        <button
          type="button"
          @click="appointmentStore.fetchAppointments()"
          :disabled="appointmentStore.isFetching"
        >
      ...
      <div class="child">
        ...
        <button
          type="button"
          @click="appointmentStore.deleteAppointment(deleteAppointment)"
...
@scope (#appointments-page) {
  #content {
    padding-block: calc(var(--g-navbar-height) + 3rem) 3rem;
