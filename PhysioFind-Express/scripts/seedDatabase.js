...
async function main() {
  ...
  try {
    ...
    const practitioners = [
      {
        ...
        bio: "Expert in sports injuries.",
      },
      {
        user_id: createdUsers[1].id,
        profession: "Massage Therapist",
        bio: "Relaxation and recovery.",
      },
      {
        user_id: createdUsers[0].id,
        profession: "Chiropractor",
        bio: "Spinal adjustments.",
      },
      {
        user_id: createdUsers[1].id,
        profession: "Osteopath",
        bio: "Holistic approach.",
      },
      {
        user_id: createdUsers[0].id,
        profession: "Acupuncturist",
        bio: "Traditional Chinese Medicine.",
      },
    ];
    ...
    const clinic = await prisma.clinics.findFirst({
      where: { name: "PhysioFind Downtown" },
    });
