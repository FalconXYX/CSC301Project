...
Command (PowerShell):
Invoke-RestMethod -Uri "http://localhost:3001/users" -Method Post -ContentType "application/json" -Body '{"email": "demo_user_final@example.com", "password_hash": "secret123", "role": "patient", "first_name": "Demo", "last_name": "Final"}'
